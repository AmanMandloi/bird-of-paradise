...
function Navbar() {
  return (
    <div>
    	<div>
      		<nav className="navbar navbar-expand-md bg-light navbar-light navbar-main" style={{"backgroundColor":"tranparent"}}>
      			<button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar" style={{"float":"right"}}>
